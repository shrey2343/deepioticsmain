...
import { ArrowRight, CheckCircle, FileText, TrendingUp, BarChart3, Users, Zap, Calendar, FileCheck, Sparkles, Star, Shield, Truck, DollarSign, Clock } from "lucide-react";
...
const painPoints = [
  { text: "🚛 Factoring reconciliation gaps" },
  { text: "📅 Receivables aging beyond 45-60 days" },
  { text: "⛽ Fuel and vendor payment overload" },
  { text: "👨‍✈️ Driver compensation tracking issues" },
  { text: "⏰ Delayed monthly closes" },
  { text: "🗺️ Multi-state financial complexity" },
];

const steps = [
  { num: "01", icon: Calendar, title: "Book Free AR/AP Review", desc: "Schedule a 20-minute call where we analyze your current receivables, payables, and cash flow visibility." },
  { num: "02", icon: FileCheck, title: "Get Custom Action Plan", desc: "We provide a clear roadmap showing exactly what needs to be fixed in your trucking financial operations." },
  { num: "03", icon: BarChart3, title: "Implement Control Systems", desc: "We install structured AR/AP processes, weekly reporting, and predictable cash flow management." },
];

const services = [
  { title: "📊 AR Aging Cleanup & Tracking", desc: "We clean up your receivables aging and implement tracking systems to ensure you get paid on time." },
  { title: "🔄 Factoring Reconciliation Management", desc: "Proper reconciliation of factoring transactions to eliminate gaps and maintain accurate records." },
  { title: "⛽ Vendor & Fuel AP Restructuring", desc: "Organize and control vendor payments, fuel expenses, and ensure nothing falls through the cracks." },
  { title: "💰 Weekly Cash Flow Reporting", desc: "Get clear weekly reports showing exactly where your cash is and what's coming in or going out." },
  { title: "📅 Structured Monthly Close Process", desc: "Timely month-end closes that give you accurate financial visibility when you need it." },
  { title: "📋 Tax-Ready Books Year-Round", desc: "Maintain clean, organized books that are always ready for tax filing and compliance." },
];

const whoWeWorkWith = [
  { title: "🚛 10-100 Truck Fleets", desc: "Perfect size for structured financial systems without enterprise complexity." },
  { title: "💵 $2M-$15M Revenue Companies", desc: "Growing operations that need professional financial control." },
  { title: "👤 Owner-Led Operations", desc: "Business owners who want visibility without hiring full-time finance staff." },
  { title: "🏢 No In-House Finance Team", desc: "Companies that need expert financial management without the overhead." },
];

const trustPoints = [
  { title: "🤝 We Work Alongside Your Team", desc: "We don't replace your operations. We collaborate with your dispatch and admin team." },
  { title: "👁️ Receivables Become Visible", desc: "Always know who owes you, how much, and when payment is expected." },
  { title: "✅ Payables Stay Controlled", desc: "Vendor payments are organized, tracked, and never missed." },
  { title: "📊 Reports Are Timely", desc: "Get the financial information you need, when you need it." },
  { title: "💰 Cash Flow Becomes Predictable", desc: "No more surprises. Know your cash position at all times." },
  { title: "🎯 Focus on Growth", desc: "Spend time growing your fleet, not chasing invoices and receipts." },
];

const faqs = [
  { q: "Do you understand trucking-specific accounting?", a: "Yes. We specialize in factoring reconciliation, fuel card management, driver settlements, and multi-state compliance for trucking companies." },
  { q: "How quickly can you clean up our AR aging?", a: "Most AR cleanup projects take 2-4 weeks. We'll give you a timeline after reviewing your current aging report." },
  { q: "What if we use factoring companies?", a: "We work with all major factoring companies and handle the reconciliation process to keep your books accurate." },
  { q: "Do we need to change our dispatch software?", a: "No. We integrate with your existing systems and work with whatever dispatch/TMS software you currently use." },
  { q: "What does this cost?", a: "Pricing depends on fleet size and transaction volume. Most clients pay $800-$2,500/month. Contact us for exact pricing." },
];

const testimonials = [
  { quote: "Finally got our factoring reconciliation under control. No more mystery gaps.", author: "Mike T.", role: "Fleet Owner, 45 Trucks" },
  { quote: "They cleaned up 6 months of AR aging in 3 weeks. Game changer.", author: "Sarah L.", role: "Operations Manager" },
  { quote: "Now I actually know my cash position every week. Worth every penny.", author: "David R.", role: "Owner-Operator, 12 Trucks" },
];

const TruckLogistics = () => {
    ...
    <div className="min-h-screen bg-background pt-16 md:pt-20">
      ...
      <section className="relative overflow-hidden py-6 sm:py-8 md:py-12 lg:py-16">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          >
            <source src="https://public-assets.content-platform.envatousercontent.com/af432ef3-b379-4e46-8a63-2aec90363a2b/f69de9bc-d99f-48b7-b1a4-41ab8946e197/af432ef3-b379-4e46-8a63-2aec90363a2b/preview_540p_crf22_higher_quality.mp4" type="video/mp4" />
          </video>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left order-1 lg:order-1">
              <div className="inline-flex items-center gap-2 px-4 sm:px-4 py-2 sm:py-2 rounded-full bg-primary/20 backdrop-blur-sm border border-primary/30 mb-5 sm:mb-6 animate-slide-up text-sm sm:text-sm bg-blue-100">
                <Truck className="h-4 w-4 sm:h-4 sm:w-4 text-primary" />
                <span className="font-medium text-primary">Trusted by 100+ Trucking Companies</span>
              </div>
              ...
              <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight animate-slide-up" style={{ animationDelay: '0.1s' }}>
                Financial Control Systems for{" "}
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent" style={{ textShadow: 'none', WebkitTextStroke: '0.5px rgba(59, 130, 246, 0.3)' }}>Trucking Companies</span>
              </h1>
              ...
              <p className="mx-auto lg:mx-0 mt-4 sm:mt-5 md:mt-7 max-w-2xl text-lg sm:text-lg md:text-xl text-gray-800 animate-slide-up leading-relaxed font-semibold" style={{ animationDelay: '0.2s' }}>
                We help US trucking companies fix AR, AP, and cash flow visibility — so growth doesn't create financial chaos.
              </p>
              ...
              <div className="mt-5 sm:mt-7 md:mt-9 flex flex-row flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm animate-slide-up" style={{ animationDelay: '0.3s' }}>
                <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 sm:py-2 rounded-lg bg-cyan-100/90 backdrop-blur-sm border border-cyan-300/50 justify-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
                  ...
                  <span className="font-medium text-cyan-800 text-xs sm:text-sm whitespace-nowrap">AR/AP Cleanup</span>
                </div>
                <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 sm:py-2 rounded-lg bg-blue-100/90 backdrop-blur-sm border border-blue-300/50 justify-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
                  <DollarSign className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 shrink-0" />
                  <span className="font-medium text-blue-800 text-xs sm:text-sm whitespace-nowrap">Cash Flow Control</span>
                </div>
                <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 sm:py-2 rounded-lg bg-purple-100/90 backdrop-blur-sm border border-purple-300/50 justify-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
                  <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 shrink-0" />
                  <span className="font-medium text-purple-800 text-xs sm:text-sm whitespace-nowrap">Weekly Reports</span>
                </div>
              </div>
            </div>
            ...
            <div className="animate-scale-in order-2 lg:order-2" style={{ animationDelay: '0.4s' }}>
              <div className="p-4 sm:p-5 md:p-6">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground">Book Trucking AR/AP Review</h3>
                <p className="text-xs sm:text-sm text-foreground/80 mt-1 mb-6">20-minute call • No obligation • Immediate insights</p>
                <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="john@truckingco.com"
                  ...
                  <Button type="submit" className="w-full rounded-full text-sm sm:text-base py-5 sm:py-6 shadow-lg hover:shadow-xl transition-all hover:scale-[1.02] animate-pulse-glow backdrop-blur-sm">
                    Book AR/AP Review <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                  </Button>
        ...
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              The Real Problem in <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Trucking</span>
            </h2>
            <p className="mx-auto mt-4 sm:mt-5 max-w-2xl text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed">
              When operations grow, accounting falls behind. Trucking companies often struggle with:
            </p>
          </div>
            ...
            {painPoints.map((p, i) => (
              ...
              >
                ...
                <CardContent className="p-5 sm:p-6 relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-500 to-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                </CardContent>
              </Card>
            ))}
          </div>
            ...
            <Card className="inline-block max-w-3xl border-2 border-blue-200 bg-gradient-to-r from-blue-500 to-purple-500 shadow-xl hover:shadow-2xl transition-all duration-300">
              <CardContent className="p-4 sm:p-5 md:p-6 lg:p-8">
                <p className="text-sm sm:text-base lg:text-lg text-white font-semibold">
                  When operations grow, accounting falls behind. You need structured financial control systems.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            ...
            <p className="mx-auto mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base md:text-lg text-muted-foreground">
              We don't just manage your books — we help you understand what your numbers actually mean for your trucking business.
            </p>
          </div>
            ...
            <CardContent className="p-5 sm:p-6 md:p-4">
              ...
              <div className="mt-6 sm:mt-8 text-center ">
                <p className="text-base sm:text-lg font-bold text-white">
                  We turn your financial data into simple business advice for your trucking operations.
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="py-6 sm:py-8 md:py-12 relative overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-purple-50/30">
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              How We Help <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Trucking Businesses</span>
            </h2>
            <p className="mx-auto mt-4 sm:mt-5 max-w-2xl text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed">
              We install structured financial control systems that include:
            </p>
          </div>

          <div className="grid gap-5 sm:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {services.map((s, i) => (
              <Card key={i} className="group relative overflow-hidden transition-all duration-500 hover:shadow-2xl bg-gradient-to-r from-blue-600 to-purple-600">
                <CardContent className="p-5 sm:p-6 relative">
                  <h3 className="font-bold text-white text-base sm:text-lg mb-2">{s.title}</h3>
                  <p className="text-xs sm:text-sm text-white leading-relaxed">{s.desc}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="relative group">
            <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden transition-all duration-500 hover:border-blue-400/40 hover:shadow-blue-100">
              ...
              <div className="bg-gradient-to-br from-blue-950 to-slate-950 relative min-h-[600px] flex items-center justify-center p-8 overflow-hidden">
                ...
                <button
                  onClick={() => {
                    const carousel = document.getElementById('mockup-carousel-trucking');
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5 lg:gap-6">
                  ...
                  <Button asChild className="w-full sm:w-auto rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105 shrink-0 bg-gradient-to-r from-cyan-500 to-blue-600 text-sm sm:text-base px-6 sm:px-8">
                    <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                      Start Free Review <ArrowRight className="ml-2 h-4 w-4" />
                    </a>
                  </Button>
                </div>
              </CardContent>
        ...
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="grid gap-5 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {whoWeWorkWith.map((item, i) => (
              <Card key={i} className="border-2 border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all duration-300 bg-white">
                <CardContent className="p-5 sm:p-6">
                  <h3 className="font-bold text-base sm:text-lg mb-2 text-purple-700">{item.title}</h3>
      ...
      {/* OUR APPROACH */}
      <section className="py-6 sm:py-8 md:py-12 bg-gradient-to-b from-white to-blue-50/30">
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            ...
            <p className="mx-auto mt-4 sm:mt-5 max-w-2xl text-sm sm:text-base text-gray-600">
              We don't replace your operations team.
            </p>
          </div>

          <div className="grid gap-5 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {trustPoints.map((t, i) => (
              <Card key={i} className="group relative overflow-hidden transition-all duration-500 hover:shadow-2xl border border-gray-200 bg-white hover:border-green-300">
                <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-emerald-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <CardContent className="p-5 sm:p-6 relative">
                  <h3 className="font-bold text-base sm:text-lg mb-2 text-purple-700 group-hover:text-cyan-600 transition-colors">{t.title}</h3>
      ...
      <section className="py-6 sm:py-8 md:py-12 bg-white">
        <div className="mx-auto max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
              What Trucking Companies <span className="gradient-text">Say</span>
            </h2>
          </div>

          <div className="grid gap-5 sm:gap-6 grid-cols-1 md:grid-cols-3">
            {testimonials.map((t, i) => (
              <Card key={i} className="card-hover-lift border-2 border-gray-200 hover:border-primary hover:shadow-2xl transition-all duration-500 group bg-gradient-to-br from-white to-gray-50 overflow-hidden relative">
      ...
      {/* FAQ */}
      <section className="py-6 sm:py-8 md:py-12 bg-gradient-to-b from-white via-purple-50/30 to-pink-50/30">
        <div className="mx-auto max-w-4xl px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <Card key={i} className="overflow-hidden border border-gray-200 hover:border-purple-300 hover:shadow-xl transition-all duration-300 group bg-white">
                <CardContent className="p-0">
                  ...
                  >
                    <div className="flex items-start gap-4 flex-1 pr-4">
                      <div className={`shrink-0 w-10 h-10 rounded-2xl flex items-center justify-center font-bold text-sm transition-all duration-300 ${
                        openFaq === i
                      ...
                      <span className={`font-bold text-sm sm:text-base transition-colors block ${
                        openFaq === i ? 'text-purple-600' : 'text-gray-900 group-hover:text-purple-600'
                      }`}>
                        {faq.q}
                      </span>
                    </div>
                    ...
                    <div className="px-5 sm:px-6 pb-5 sm:pb-6 border-t border-gray-200 bg-gradient-to-r from-purple-50/50 to-pink-50/50 animate-slide-up">
                      <div className="pt-5 flex items-start gap-3">
                        <div className="shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
                          <CheckCircle className="h-4 w-4 text-green-600 stroke-[2.5]" />
                        </div>
        ...
        <div className="mx-auto max-w-4xl px-3 sm:px-4 md:px-6 lg:px-8 text-center relative">
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30">
              ...
              <span className="text-white text-xs sm:text-sm font-semibold">Free 20-Min Review</span>
            </div>
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30">
              <Shield className="h-4 w-4 text-white" />
              <span className="text-white text-xs sm:text-sm font-semibold">No Obligation</span>
            </div>
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30">
              <Zap className="h-4 w-4 text-white" />
              <span className="text-white text-xs sm:text-sm font-semibold">Immediate Insights</span>
            </div>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-4 sm:mb-6">
            Get Clarity on Your AR & AP <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-white">in 20 Minutes</span>
          </h2>

          <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl text-white/90 leading-relaxed mb-8 sm:mb-10">
            Schedule a free trucking financial health review. We'll analyze your current situation and show you exactly what needs to be fixed.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 sm:mb-10 px-4 sm:px-0">
            <Button asChild size="lg" className="w-full sm:w-auto rounded-full px-6 sm:px-8 md:px-10 lg:px-12 text-sm sm:text-base md:text-lg py-5 sm:py-6 md:py-7 bg-white text-purple-600 hover:bg-gray-100 shadow-2xl hover:shadow-3xl transition-all hover:scale-105 font-bold">
              <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
                Book My Free Review <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </a>
            </Button>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 px-4 sm:px-0">
            ...
            <p className="text-white/90 text-xs sm:text-sm md:text-base font-medium text-center">
              Join 100+ trucking companies who trust us with their financial operations
            </p>
          </div>
        </div>
      </section>
