        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">AI Partner</span>
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Empowering your business with end-to-end AI-driven solutions from website creation, App development to impactful business growth .
            </p>
