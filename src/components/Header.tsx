          ...
          <nav className="hidden lg:flex items-center space-x-4 xl:space-x-8">
            ...
            <div className="relative services-dropdown-container">
              ...
              {isServicesDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                  ...
                  {/* Accounting submenu - temporarily hidden
                  <div className="relative group">
                    ...
                    {isAccountingSubmenuOpen && (
                      ...
                      >
                        <a href="/accounting/truck-logistics" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                          Truck & Logistics
                        </a>
                      </div>
                    )}
            ...
            <div className="relative insights-dropdown-container">
              ...
              {isInsightsDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                  <a href="/blog" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">Blog</a>
                  <a href="/media" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">Media</a>
                  <a href="/publication" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">Publication</a>
                  <a href="/careers" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">Careers</a>
                  <a href="/contact" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">Contact</a>
                </div>
              )}
            </div>
            */}
            <a href="/media" className="font-medium text-sm xl:text-base transition-colors hover:text-blue-600 text-gray-700">Media</a>
            <a href="/publication" className="font-medium text-sm xl:text-base transition-colors hover:text-blue-600 text-gray-700">Publication</a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200 bg-white/95 backdrop-blur-md rounded-b-lg shadow-lg">
            <div className="flex flex-col space-y-1 px-4">
              ...
              {/* Accounting Services - temporarily hidden
              <a href="/accounting/us-accounting" className="font-medium transition-colors hover:text-blue-600 text-gray-700 py-3 px-2 rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Accounting Services</a>
              */}
              <div>
                <button 
                  onClick={() => setIsServicesDropdownOpen(!isServicesDropdownOpen)}
                ...
                {isServicesDropdownOpen && (
                  <div className="mt-1 ml-2 space-y-1">
                    ...
                    {/* Accounting submenu - temporarily hidden
                    <div>
                      <button onClick={() => setIsAccountingSubmenuOpenMobile(!isAccountingSubmenuOpenMobile)} className="flex items-center justify-between w-full py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100">
                        <span>Accounting</span>
                      ...
                      {isAccountingSubmenuOpenMobile && (
                        <div className="mt-1 ml-4 space-y-1">
                          <a href="/accounting/us-accounting" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>US Accounting</a>
                          <a href="/accounting/truck-logistics" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Truck & Logistics</a>
                        </div>
                      )}
                    </div>
                    */}
              ...
              {/* Insights dropdown - temporarily hidden
              <div>
                <button onClick={() => setIsInsightsDropdownOpen(!isInsightsDropdownOpen)} className="font-medium transition-colors hover:text-blue-600 text-gray-700 flex items-center justify-between w-full py-3 px-2 rounded-lg hover:bg-blue-50 active:bg-blue-100">
                  <span>Insights</span>
                  <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isInsightsDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
                {isInsightsDropdownOpen && (
                  <div className="mt-1 ml-2 space-y-1">
                    <a href="/blog" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Blog</a>
                    <a href="/media" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Media</a>
                    <a href="/publication" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Publication</a>
                    <a href="/careers" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Careers</a>
                    <a href="/contact" className="block py-3 px-4 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Contact</a>
                  </div>
                )}
              </div>
              */}
              <a href="/media" className="font-medium transition-colors hover:text-blue-600 text-gray-700 py-3 px-2 rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Media</a>
              <a href="/publication" className="font-medium transition-colors hover:text-blue-600 text-gray-700 py-3 px-2 rounded-lg hover:bg-blue-50 active:bg-blue-100" onClick={() => setIsMenuOpen(false)}>Publication</a>
              <a
                href="https://tidycal.com/team/deepiotics-team/call"
                target="_blank"
                rel="noopener noreferrer"
