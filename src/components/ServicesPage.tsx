import { Bot, Brain, LineChart, Workflow, MessageSquare, Shield, Zap, Code, Database, Cpu, Network, CloudCog, HeartPulse } from 'lucide-react';
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Intelligent AI solutions purpose-built for healthcare providers, clinics, and health-tech companies to improve patient outcomes and streamline operations.',
      features: [
        ...
        'HIPAA-compliant data handling and integrations'
      ],
      benefits: [
        'Reduced administrative burden on clinical staff',
        'Faster and more accurate diagnoses',
        'Improved patient engagement and retention',
        'Lower operational costs with smart automation'
      ]
    },
    {
      icon: Database,
